...
const soundsMap = {
  ...
  'entity.pig_big.ambient': { name: 'mob.big_pig.say' },
  'entity.pig_big.hurt': { name: 'mob.big_pig.hurt' },
  ...
  'entity.wolf_angry.growl': { name: 'mob.wolf.mad.growl' },
  'entity.wolf_big.ambient': { name: 'mob.wolf.big.bark' },
  'entity.wolf_big.growl': { name: 'mob.wolf.big.growl' },
  'entity.wolf_cute.ambient': { name: 'mob.wolf.cute.bark' },
  'entity.wolf_cute.growl': { name: 'mob.wolf.cute.growl' },
  'entity.wolf_grumpy.ambient': { name: 'mob.wolf.grumpy.bark' },
  'entity.wolf_grumpy.growl': { name: 'mob.wolf.grumpy.growl' },
  'entity.wolf_puglin.ambient': { name: 'mob.wolf.puglin.bark' },
  'entity.wolf_puglin.growl': { name: 'mob.wolf.puglin.growl' },
  'entity.wolf_sad.ambient': { name: 'mob.wolf.sad.bark' },
  'entity.wolf_sad.growl': { name: 'mob.wolf.sad.growl' },
  'entity.wolf.ambient': { name: 'mob.wolf.bark' },
  'entity.wolf.growl': { name: 'mob.wolf.growl' },
