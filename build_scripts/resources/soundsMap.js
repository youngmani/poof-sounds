...
const soundsMap = {
  ...
  'block.bamboo_wood_door.close': { name: 'close.bamboo_wood_door' },
  'block.bamboo_wood_door.open': { name: 'open.bamboo_wood_door' },
  'block.barrel.open': {
  ...
  'block.cherry_wood_door.close': { name: 'close.cherry_wood_door' },
  'block.cherry_wood_door.open': { name: 'open.cherry_wood_door' },
  ...
  'block.nether_wood_door.close': { name: 'close.nether_wood_door' },
  'block.nether_wood_door.open': { name: 'open.nether_wood_door' },
  'block.note_block.bass': { name: 'note.bass' },
  'block.note_block.bell': { name: 'note.bell' },
  'block.note_block.bit': { name: 'note.bit' },
  'block.note_block.didgeridoo': { name: 'note.didgeridoo' },
  'block.note_block.harp': { name: 'note.harp' },
  'block.note_block.snare': { name: 'note.snare' },
  ...
  'block.wooden_door.close': { name: 'close.wooden_door' },
  'block.wooden_door.open': { name: 'open.wooden_door' },
  ...
  'entity.chicken_picky.ambient': { name: 'mob.picky_chicken.say' },
  'entity.chicken.ambient': { name: 'mob.chicken.say' },
